module.exports = function container (get, set, clear) {
  ...
  var strategy = {
    name: 'golden-ea-zen',
    description: 'Adaptierte Version des MT4 Golden EA. Nutzt eine vereinfachte Korrelations- und Momentum-Logik.',

    getOptions: function () {
      this.option('period', 'period length', String, '1m')
      this.option('min_pips_filter', 'Mindest-Pips-Bewegung des letzten Bars als Filter (entspricht MinPips)', Number, 250)
    ...
    onPeriod: function (s, cb) {
      ...
      // Der Original-EA prüft, ob zwei Paare (XAUUSD und XAUEUR) in die gleiche Richtung gehen und die Kerzengröße groß genug ist.
      // Da Zenbot nur ein Paar handelt, simulieren wir dies durch eine starke Momentum-Anforderung auf dem aktuellen Paar.
