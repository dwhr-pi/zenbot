module.exports = function container (get, set, clear) {
  ...
  var strategy = {
    name: 'bigrise-ea-zen',
    description: 'Adaptierte Version des MT4 BigRise EA. Nutzt eine vereinfachte Momentum-Logik mit optionaler Martingale-Anpassung.',

    getOptions: function () {
      this.option('period', 'period length', String, '1m')
      this.option('min_pips_filter', 'Mindest-Pips-Bewegung des letzten Bars als Filter (entspricht MinPips)', Number, 5)
    ...
    onPeriod: function (s, cb) {
      ...
      // Der Original-EA prüft die Korrelation von 5 Paaren. Hier simulieren wir dies durch eine starke Momentum-Anforderung auf dem aktuellen Paar.
