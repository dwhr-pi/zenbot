# Zenbot Strategie: Boom-EA-Zen (Adaptierte Version)

## 1. Strategiebeschreibung

Die Strategie **Boom-EA-Zen** ist eine für Zenbot adaptierte Version des ursprünglichen MT4 Expert Advisors "Boom EA". Der ursprüngliche EA basierte auf einer **Multi-Währungs-Korrelationsanalyse** (7 Währungspaare) und einer **Martingale-Grid-Logik**.
...
| `min_pips_filter` | Mindest-Pips-Bewegung des letzten Bars als Filter (entspricht MinPips) | Number | `10` |
...
./zenbot.sh backtest ETH-USD --strategy=boom-ea-zen --period=1m --min_pips_filter=10 --martingale_factor=1.2
```

## 3. Implementierungsdetails (strategy.js)

Die Logik ist in der Datei `Boom-EA-Zen.js` implementiert.

```javascript
// Auszug aus Boom-EA-Zen.js
// ...
